  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-gray-200 h-auto lg:max-w-full overflow-x-auto">
        <div className='flex ml-[2.5%] justify-left'>
            ...
            <h2 className='px-4 font-mono font-bold text-3xl'>New Song Releases</h2>
        </div>
        <div className="flex flex-row gap-4 items-center rounded-lg bg-gray-200 h-auto lg:max-w-full overflow-x-auto">
            ...
            <div className="flex overflow-x-auto whitespace-nowrap space-x-4 mt-4 mb-4 rounded-lg" ref={scrollContainerRef}>
                ...
                >
                    ...
                    <div className="w-full overflow-hidden text-black text-sm">{song.artist}</div>
                    <div className="text-black">{song.genre}</div>
                    </div>
                </div>
                ))}
            </div>
